...
namespace Labbook.Controllers
{
    public class ToolController : Controller
    {
        ...
        public ToolController(LabbookContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,LabID,toolName,quantity")] Tool tool)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LabID,toolName,quantity")] Tool tool)
        {
            if (id != tool.Id)
            {
                return NotFound();
